...
function onMouseWheel(event) {
    ...
    var distX = event.offsetX / canvas.clientWidth;
    var distY = event.offsetY / canvas.clientHeight;
...
function onTouchMove(event) {
    ...
    const touch0X = event.touches[0].offsetX;
    const touch0Y = event.touches[0].offsetY;
    const prevTouch0X = prevTouches[0].offsetX;
    const prevTouch0Y = prevTouches[0].offsetY;
    ...
    if (doubleTouch) {
        ...
        const touch1X = event.touches[1].offsetX;
        const touch1Y = event.touches[1].offsetY;
        const prevTouch1X = prevTouches[1].offsetX;
        const prevTouch1Y = prevTouches[1].offsetY;
